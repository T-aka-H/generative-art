...
| 図形 | 軌道物理 | 視覚効果 |
|------|----------|----------|
| 丸 (circle) | 連続曲率 (~0.04 rad/frame) → 円軌道 | ループ状の軌跡 |
...
連続的な曲率 `0.04 * turnDir + noise * 0.015` を毎フレーム角度に加算し、半径約 62px の円弧を描き続けます。400〜800px 走行ごとに 30% の確率で旋回方向が反転し、8 の字状の軌跡が生まれます。
